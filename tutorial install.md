...
- Sesuaikan partition scheme dan ukuran storage yang akan dibutuhkan untuk install arch linux dari storage yang digunakan via disk management. Caranya liat di web https://www.bagitekno.net/windows/cek-hardisk-gpt-atau-mbr.html
